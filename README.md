...
<body>
  ...
  <main>
    ...
    <div class="info">
      ...
      <p><strong>🧢 Одежда:</strong> строительная каска, с собой кирпичи</p>
      <p><strong>🔍 Особые приметы:</strong> могут быть заметны усы на лице, на слово "на" отвечает "хуй на тебе гандон", использует такие слова как "шма", "на зеленый", "бмв" и "сосал"</p>
